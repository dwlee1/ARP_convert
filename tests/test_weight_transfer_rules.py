...
def test_leg_family_splits_by_owned_lengths_only():
    ...
    arp_meta = {
        ...
        'thigh_stretch.l': _arp('thigh_stretch.l', 'thigh_ref.l', family_kind='stretch', length=1.0),
    }
...
def test_leg_mapping_does_not_leak_to_adjacent_segment_family():
    ...
    arp_meta = {
        ...
        'leg_twist.l': _arp('leg_twist.l', 'leg_ref.l', family_kind='twist', head=(0.0, 0.2, 0.0), length=1.0),
    }
...
def test_auxiliary_heel_and_bank_bones_are_excluded():
    ...
    arp_meta = {
        ...
        'foot_heel.l': _arp('foot_heel.l', 'foot_ref.l', head=(0.0, 0.0, 0.0), length=5.0, is_auxiliary=True),
        'foot_bank_01.l': _arp('foot_bank_01.l', 'foot_ref.l', head=(0.0, 0.0, 0.0), length=5.0, is_auxiliary=True),
    }
